...
namespace Lightning
{
	...
	namespace Scene
	{
		...
		void Primitive::UpdateRenderNode(IRenderer* renderer)
		{
			...
			float a, r, g, b;
			GetColor(a, r, g, b);
			SetMaterialParameter(mRenderNode.material, Render::ShaderType::FRAGMENT, "color", Vector4f{ r, g, b, a });
			SetMaterialParameter(mRenderNode.material, Render::ShaderType::FRAGMENT, "light", Vector3f{3, 3, 3});
