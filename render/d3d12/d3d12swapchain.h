...
namespace Lightning
{
	namespace Render
	{
		...
		public:
			...
			D3D12SwapChain(IDXGIFactory4* factory, ID3D12CommandQueue* commandQueue, IWindow* pWindow);
		...
		private:
			...
			void CreateNativeSwapChain(IDXGIFactory4* factory, ID3D12CommandQueue* pCommandQueue, IWindow* pWindow);
